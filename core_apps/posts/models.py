...
class Post(TimeStampedModel):
  ...
  def save(self, *args, **kwargs) -> None:
    if not (self.author.is_superuser or self.author.is_staff or self.author.occupation == Profile.Occupation.TENANT):
      raise ValueError(
        "Only tenants, superuser or staff members can create posts."
      )
...
class Reply(TimeStampedModel):
  ...
  author = models.ForeignKey(User, verbose_name=_("Author"), on_delete=models.CASCADE, related_name="replies")
