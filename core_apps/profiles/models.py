...
class Profile(TimeStampedModel):
  ...
  phone_number = PhoneNumberField(verbose_name=_("Phone Number"), max_length=30, default="+8801708915045")
  country_of_origin = CountryField(verbose_name=_("Country"), default="BD")
  city_of_origin = models.CharField(verbose_name=_("City"), max_length=180, default="Dhaka")
  report_count = models.PositiveIntegerField(verbose_name=_("Report Count"), default=0)
